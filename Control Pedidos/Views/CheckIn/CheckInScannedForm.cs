...
{
    /// <summary>
    /// Muestra los pedidos que ya cuentan con CheckIN (estatus CI) y permite exportarlos a Excel.
    /// </summary>
    public class CheckInScannedForm : Form
    {
        ...
        public CheckInScannedForm(DatabaseConnectionFactory connectionFactory, int empresaId, int? eventoId, bool sinEvento, string descripcionEvento)
        {
        ...
        private void ExportButton_Click(object sender, EventArgs e)
        {
            ...
            using (var dialog = new SaveFileDialog())
            {
                ...
                dialog.FileName = $"PedidosEscaneados_{DateTime.Today:yyyyMMdd}.xlsx";
        ...
        private DataTable CrearTabla()
        {
            ...
            foreach (var pedido in _pedidos)
            {
                tabla.Rows.Add(
                    ...
                    pedido.FechaCheckIn?.ToString("dd/MM/yyyy HH:mm") ?? "");
            }
